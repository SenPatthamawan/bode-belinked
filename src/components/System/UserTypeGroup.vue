              ...
              <v-expansion-panel>
                ...
                <v-expansion-panel-content>
                  <v-card elevation="2">
                    <v-card-text>
                      <form>
                        <v-row>
                          <v-col cols="6">
                            <v-text-field
                              label="userTypeGroupCode"
                              placeholder="userTypeGroupCode"
                              v-model="search.userTypeGroupCode"
                              outlined
                              dense
                            ></v-text-field>
                          </v-col>
                          <v-col cols="6">
                            <v-text-field
                              label="userTypeGroupName"
                              placeholder="userTypeGroupName"
                              v-model="search.userTypeGroupName"
                              outlined
                              dense
                            ></v-text-field>
                          </v-col>
                    ...
                    >
                      <v-select
                        v-model="search.CAN_VIEW"
                        :items="userTypeItem"
                        label="สามารถ ดูข้อมูลได้"
                      ></v-select>
                    </v-col>
                    <v-col
                      class="d-flex"
                    ...
                    >
                      <v-select
                        v-model="search.CAN_ADD"
                        :items="userTypeItem"
                        label="สามารถ เพิ่มข้อมูลได้"
                      ></v-select>
                    </v-col>
                    <v-col
                      class="d-flex"
                    ...
                    >
                      <v-select
                        v-model="search.CAN_UPDATE"
                        :items="userTypeItem"
                        label="สามารถ แก้ไขข้อมูลได้"
                      ></v-select>
                    </v-col>
                    <v-col
                      class="d-flex"
                    ...
                    >
                      <v-select
                        v-model="search.CAN_DELETE"
                        :items="userTypeItem"
                        label="สามารถ ลบข้อมูลได้"
                      ></v-select>
                    </v-col>
                    <v-col
                      class="d-flex"
                    ...
                    >
                      <v-select
                        v-model="search.CAN_IMPORT"
                        :items="userTypeItem"
                         label="สามารถ นำเข้าข้อมูลได้"
                      ></v-select>
                    </v-col>
                    <v-col
                      class="d-flex"
                    ...
                    >
                      <v-select
                        v-model="search.CAN_EXPORT"
                        :items="userTypeItem"
                        label="สามารถ ส่งออกข้อมูลได้"
                      ></v-select>
                    </v-col>
                        </v-row>
                        <!-- ค้นหาวันที่สร้างข้อมูล และ วันที่แก้ไขข้อมูล -->
                        <v-row>
                          <v-col cols="6">
                            <v-menu
                              ref="menu"
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12">
                      <v-text-field
                        label="userTypeGroupName*"
                        v-model="formAdd.userTypeGroupName"
                        :rules="nameRules"
                        :counter="10"
                        maxlength="10"
                        required
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12">
                      <v-text-field
                        label="userTypeGroupCode*"
                        v-model="formUpdate.userTypeGroupCode"
                        :rules="nameRules"
                        :counter="30"
                        maxlength="30"
                        required
                    ...
                    <v-col cols="4">
                      <v-text-field
                        label="userTypeGroupName*"
                        v-model="formUpdate.userTypeGroupName"
                        :rules="nameRules"
                        :counter="10"
                        maxlength="10"
                        required
...
export default {
  ...
  data () {
    return {
      PK: '',
      path: '/system_user_type_group/', // Path Model
      dataReady: true,
      ...
      formAdd: {
        ...
        CAN_VIEW: 'เปิดใช้งาน',
        CAN_ADD: 'เปิดใช้งาน',
        CAN_UPDATE: 'เปิดใช้งาน',
        CAN_DELETE: 'เปิดใช้งาน',
        CAN_IMPORT: 'เปิดใช้งาน',
        CAN_EXPORT: 'เปิดใช้งาน'
      },
      formUpdate: {
        userTypeGroupCode: '',
        userTypeGroupName: '',
      ...
      breadcrumbs: [
        ...
        },
        {
          text: 'จัดการ Account',
          disabled: true,
          href: '/System/UserTypeGroup'
        }
      ],
      // End Menu Config
      // Data Table Config
      columns: [
        { text: 'userTypeGroupID', value: 'userTypeGroupID' },
        { text: 'userTypeGroupName', value: 'userTypeGroupName' },
        { text: 'CAN_VIEW', value: 'CAN_VIEW' },
        { text: 'CAN_ADD', value: 'CAN_ADD' },
        { text: 'CAN_UPDATE', value: 'CAN_UPDATE' },
        { text: 'CAN_DELETE', value: 'CAN_DELETE' },
        { text: 'CAN_IMPORT', value: 'CAN_IMPORT' },
        { text: 'CAN_EXPORT', value: 'CAN_EXPORT' },
      ...
      columnsImport: [
        { text: 'userTypeGroupID', value: 'userTypeGroupID' },
        { text: 'userTypeGroupCode', value: 'userTypeGroupCode' },
        { text: 'userTypeGroupName', value: 'userTypeGroupName' },
        { text: 'CAN_VIEW', value: 'CAN_VIEW' },
        { text: 'CAN_ADD', value: 'CAN_ADD' },
        { text: 'CAN_UPDATE', value: 'CAN_UPDATE' },
      ...
      // Export Config
      exportType: 'xls',
      exportFileName: 'System-User-Type-group.xls',
      exportWorksheet: 'WorkSheet',
      export_fields: {
        userTypeGroupID: 'userTypeGroupID',
        userTypeGroupCode: 'userTypeGroupCode',
      ...
      // End Export Config
      userTypeItem: [
        { text: 'เปิด ใช้งาน', value: 'เปิดใช้งาน' },
        { text: 'ปิด ใช้งาน', value: 'ปิดใช้งาน' }
      ]
    }
  },
  async mounted () {
  ...
  methods: {
    async getDataById (item) {
      ...
      // Get ID /main.js
      this.dataReady = false
      this.getDataByIdGlobal(this.DNS_IP, this.path, 'userTypeGroupID', item.userTypeGroupID)
    },
    async addData () {
      //
      //
      ...
      //
      this.formAdd.userTypeGroupCode = this.code + this.generateCodeGlobal()
      //
      // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // //
    ...
    async searchDataAll () {
      ...
      //
      var search =
        '?userTypeGroupCode=' + this.searchAll + '&userTypeGroupName=' + this.searchAll
      this.dataReady = false
    ...
    async clearData () {
      ...
      for (var key in this.formAdd) {
        ...
        if (key === 'userTypeGroupCode') {
          if (this.formAdd[key]) {
            this.formAdd[key] = ''
          }
        } else if (key === 'userTypeGroupName') {
          if (this.formAdd[key]) {
            this.formAdd[key] = ''
          }
        } else {
          if (this.formAdd[key]) {
            this.formAdd[key] = 'เปิดใช้งาน'
          }
        }
      }
      ...
      this.$swal({
        ...
        .then(async (result) => {
          for (var key in this.dataItemImport) {
            this.PK = this.dataItemImport[key].userTypeGroupID
            if (action === 'add') {
              console.log('add')
              ...
              await axios
                .get(
                  ...
                  this.DNS_IP +
                    this.path +
                    'get?userTypeGroupID=' +
                    this.dataItemImport[key].userTypeGroupID,
                  {
                    headers: {
                ...
                .catch((error) => {
                  ...
                  console.log('error /system_user_type_group/get?userTypeGroupID : ', error)
                })
            }
          }
    ...
    async importDataAdd (dt) {
      ...
      delete this.formAdd['userTypeGroupID']
      ...
      await axios
        ...
        .then(async (response) => {
          ...
          // Debug response
          console.log('/system_user_type_group/add/', response)
        })
        // eslint-disable-next-line handle-callback-err
        .catch((error) => {
    ...
    async importDataUpdate (dt) {
      ...
      this.formUpdate.LAST_USER = this.$session.getAll().data.userTypeGroupName
      ...
      await axios
        ...
        .then(async (response) => {
          this.dialogImport = false
          // Debug response
          console.log('/system_user_type_group/edit/', response)
        })
        // eslint-disable-next-line handle-callback-err
        .catch((error) => {
          alert('โปรดใส่ไฟล์ให้ถูกต้อง', dt)
    ...
    async importDataDelete (dt) {
      ...
      await axios
        .post(
          // eslint-disable-next-line quotes
          this.DNS_IP + this.path + "delete/" + dt.userTypeGroupID,
          this.formUpdate,
          {
            headers: {
              'Application-Key': this.$session.getAll().ApplicationKey
        ...
        .then(async (response) => {
          this.dialogImport = false
          // Debug response
          console.log('/system_user_type_group/delete/', response)
        })
        // eslint-disable-next-line handle-callback-err
        .catch((error) => {
          alert('โปรดใส่ไฟล์ให้ถูกต้อง', dt)
